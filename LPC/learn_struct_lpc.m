function [undirected_G,sep,zMin,ci_num] = learn_struct_lpc(Data, k, alpha, init_G)
...
% k is an maximal order of PC algorithm (default: 2), k=-1 menas that no limit on order of conditional independence tests
% alpha is the significant level for partial correlation, the default alpha value is 0.05
% init_G is the initial graph to start learning
%
